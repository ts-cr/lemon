...
-- -*- lua -*-
--
-- Godzilla IVR with avmd support (Automatic Voicemail Machine Detection)
--
...
function onInput(session, type, obj)
    ...
    if type == "event" and voicemail_detected == false then
        ...
        session:streamFile("/usr/local/freeswitch/sounds/godzilla/voicemail_1.wav");
...
-- play a file
session:streamFile("/usr/local/freeswitch/sounds/godzilla/voice_press_1.wav");
